...
- [2026-09-05 — GPT-5.6-sol 全38ケース](./results/2026-09-05-gpt-5.6-sol-full-v0.2.22/report.md) — Skillなし16/38、Skillあり38/38、改善22・同等16・悪化0
- [2026-09-05 — 開発・追試の評価履歴36件](./results/history/README.md) — Skill側の不合格と修正後の再評価を実行順に公開
